...
<div class="flex flex-col lg:flex-row items-center my-14">
    ...
    <div class="w-full lg:w-2/4 pa-3 text-left p-3">
        ...
        <h2 class="text-yellow-400 text-2xl md:text-4xl font-bold drop-shadow-lg leading-relaxed my-5 md:leading-relaxed">CoVid-19 Contact Tracing and Monitoring App</h2>
        <p class="text-white/70 text-md md:text-lg leading-loose drop-shadow-md md:leading-loose">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. No one.</p>
...
<div class="flex flex-col lg:flex-row-reverse items-center my-14">
    ...
    <div class="w-full lg:w-2/4 pa-3 text-left p-3">
        ...
        <h2 class="text-yellow-400 text-2xl md:text-4xl font-bold drop-shadow-lg leading-relaxed md:leading-relaxed my-5">Mobile Wallet and Earning Application</h2>
        <p class="text-white/70 text-md md:text-lg leading-loose md:leading-loose drop-shadow-md">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. No one.</p>
        <a class="text-yellow-400 drop-shadow-lg uppercase mt-10 inline-block font-bold text-md tracking-widest border-b-2 hover:border-yellow-400 border-yellow-400/20" href="#!">VIEW CASE STUDY</a>
    </div>
</div>
...
<div class="flex flex-col lg:flex-row items-center my-14">
    ...
    <div class="w-full lg:w-2/4 pa-3 text-left p-3">
        ...
        <h2 class="text-yellow-400 text-2xl md:text-4xl font-bold drop-shadow-lg leading-relaxed md:leading-relaxed my-5">Document Sharing Platform for Schools</h2>
        <p class="text-white/70 text-md md:text-lg leading-loose md:leading-loose drop-shadow-md">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. No one.</p>
        <a class="text-yellow-400 drop-shadow-lg uppercase mt-10 inline-block font-bold text-md tracking-widest border-b-2 hover:border-yellow-400 border-yellow-400/20" href="#!">VIEW CASE STUDY</a>
    </div>
</div>
